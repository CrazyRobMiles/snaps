...
class Ch08_09_TinyContactBookRoamingStore
{
    ...
    bool FetchContact(string name, out string address, out string phone)
    {
        ...
        address = SnapsEngine.FetchStringFromRoamingStorage(itemName: name + ":address");
        phone = SnapsEngine.FetchStringFromRoamingStorage(itemName: name + ":phone");
    ...
    void StoreContact(string name, string address, string phone)
    {
        ...
        SnapsEngine.SaveStringToRoamingStorage(itemName: name + ":address",
                                            itemValue: address);
        SnapsEngine.SaveStringToRoamingStorage(itemName: name + ":phone",
                                            itemValue: phone);
    }
    ...
    void NewContact()
    {
        SnapsEngine.DisplayString("Enter the name");
    ...
    void FindContact()
    {
        ...
        // Variables to hold the name and address being fetched
