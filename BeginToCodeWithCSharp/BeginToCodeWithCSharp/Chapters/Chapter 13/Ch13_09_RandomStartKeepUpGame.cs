...
public class Ch13_09_RandomStartKeepUpGame
{
    ...
    Random ballPosition = new Random(1);
    ...
    public void resetGame()
    {
        ...
        YBallSpeed = 10;
        ball.Top = 0;
        double availableWidth = SnapsEngine.GameViewportWidth - ball.Width;
        double randomStartPosition = ballPosition.NextDouble() * availableWidth;
        ball.Left = randomStartPosition;
