...
public class Ch15_02_GameClass
{
    ...
    public class SpaceRocketsInSpaceGame
    {
        ...
        public void PlayGame()
        {
            ...
            rocket = new RocketSprite(sprite: rocketImage,  xSpeed: 10, ySpeed: 10);
            sprites.Add(rocket);
            ...
            chaser = new ChasingAlien(sprite: chasingAlienImage, target: rocket, xAcceleration: .3, yAcceleration: .3, friction: 0.99);
            sprites.Add(chaser);
            aliens.Add(chaser);
